...
const navigation = [
    ...
    { name: 'Payment Gateways', href: route('superadmin.settings.payment-gateways.index'), icon: Globe, active: 'superadmin.settings.payment-gateways.*' },
    { name: 'Pricing Plans', href: route('superadmin.settings.pricing-plans.index'), icon: Banknote, active: 'superadmin.settings.pricing-plans.*' },
    ...
    { 
        name: 'Notifications', 
        icon: Bell, 
        active: ['superadmin.requests.onboarding.*', 'superadmin.requests.domains.*'],
        children: [
            { name: 'Onboarding', href: route('superadmin.requests.onboarding.index'), active: 'superadmin.requests.onboarding.*', badge: 'pending_onboarding_requests' },
            { name: 'Domain Requests', href: route('superadmin.requests.domains.index'), active: 'superadmin.requests.domains.*', badge: 'pending_domain_requests' },
        ]
    },
];
