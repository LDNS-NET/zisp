...
<template>
    <GuestLayout>
        ...
        <div class="mb-10 text-center">
            <div class="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-orange-500/10 mb-6 border border-orange-500/20">
                <User class="w-8 h-8 text-orange-600 dark:text-orange-400" />
            </div>
        ...
        <form @submit.prevent="submit" class="space-y-6">
            ...
            <div class="space-y-2">
                ...
                <div class="relative group">
                    <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                        <Building2 class="h-5 w-5 text-gray-400 group-focus-within:text-orange-500 transition-colors" />
                    </div>
                    <TextInput
                        id="name"
                        type="text"
                        class="block w-full pl-11 rounded-xl border-gray-200 bg-gray-50/50 px-4 py-3.5 text-gray-900 shadow-sm transition-all focus:border-orange-500 focus:bg-white focus:ring-4 focus:ring-orange-500/10 dark:border-gray-700 dark:bg-gray-900/50 dark:text-white dark:focus:border-orange-400 dark:focus:bg-gray-900"
                        v-model="form.name"
                        required
                        autofocus
                        autocomplete="name"
                        placeholder="e.g. Mfire Networks"
                    />
                </div>
            ...
            <div class="grid gap-6 md:grid-cols-2">
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative group">
                        <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                            <User class="h-5 w-5 text-gray-400 group-focus-within:text-orange-500 transition-colors" />
                        </div>
                        <TextInput
                            id="username"
                            type="text"
            ...
            <div class="grid gap-6 md:grid-cols-2">
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative group">
                        <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                            <Phone class="h-5 w-5 text-gray-400 group-focus-within:text-orange-500 transition-colors" />
                        </div>
                        <TextInput
                            id="phone"
                            type="text"
                ...
                <div class="space-y-2">
                    <div class="flex items-center justify-between ml-1">
                        ...
                        <button 
                            ...
                            class="text-xs font-medium text-orange-600 hover:text-orange-500 dark:text-orange-400 dark:hover:text-orange-300 transition-colors"
                        >
                            Country not listed?
                        </button>
                    </div>
                    <div class="relative group">
                        <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                            <Globe class="h-5 w-5 text-gray-400 group-focus-within:text-orange-500 transition-colors" />
                        </div>
                        <select
                            id="country"
                            class="block w-full pl-11 rounded-xl border-gray-200 bg-gray-50/50 px-4 py-3.5 text-gray-900 shadow-sm transition-all focus:border-orange-500 focus:bg-white focus:ring-4 focus:ring-orange-500/10 dark:border-gray-700 dark:bg-gray-900/50 dark:text-white dark:focus:border-orange-400 dark:focus:bg-gray-900"
            ...
            <div class="pt-4">
                <PrimaryButton
                    class="w-full justify-center rounded-xl bg-gradient-to-r from-orange-600 to-red-600 px-8 py-4 text-base font-bold text-white shadow-xl shadow-orange-500/20 transition-all hover:from-orange-700 hover:to-red-700 hover:scale-[1.02] active:scale-[0.98] focus:outline-none focus:ring-4 focus:ring-orange-500/20 disabled:opacity-50"
            ...
            <div class="mt-8 text-center">
                <p class="text-sm text-gray-600 dark:text-gray-400">
                    ...
                    <Link
                        :href="route('login')"
                        class="font-bold text-orange-600 hover:text-orange-500 dark:text-orange-400 dark:hover:text-orange-300 transition-colors"
                    >
                        Log in here
                    </Link>
                </p>
        ...
        <Modal :show="showOnboardingModal" @close="showOnboardingModal = false">
            <div class="p-8 bg-gray-900 rounded-2xl border border-white/10">
                <div class="flex items-center justify-between mb-6">
                    <div class="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-orange-500/10 border border-orange-500/20">
                ...
                <form @submit.prevent="submitOnboarding" class="space-y-6">
                    <div class="grid gap-6 sm:grid-cols-2">
                        <div class="space-y-2">
                            ...
                            <div class="relative group">
                                <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                    <User class="h-5 w-5 text-gray-500 group-focus-within:text-orange-500 transition-colors" />
                                </div>
                                <input 
                                    v-model="onboardingForm.name"
                                    type="text" 
                                    required
                                    class="w-full pl-11 rounded-xl bg-white/5 border-white/10 text-white focus:border-orange-500 focus:ring-4 focus:ring-orange-500/10 transition-all"
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative group">
                                <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                    <Mail class="h-5 w-5 text-gray-500 group-focus-within:text-orange-500 transition-colors" />
                                </div>
                                <input 
                    ...
                    <div class="grid gap-6 sm:grid-cols-2">
                        <div class="space-y-2">
                            ...
                            <div class="relative group">
                                <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                    <Building2 class="h-5 w-5 text-gray-500 group-focus-within:text-orange-500 transition-colors" />
                                </div>
                                <input 
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative group">
                                <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                    <Globe class="h-5 w-5 text-gray-500 group-focus-within:text-orange-500 transition-colors" />
                                </div>
                                <input 
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative group">
                            <div class="absolute top-3 left-4 pointer-events-none">
                                <MessageSquare class="h-5 w-5 text-gray-500 group-focus-within:text-orange-500 transition-colors" />
                            </div>
                            <textarea 
                    ...
                    <div class="flex gap-4 pt-4">
                        ...
                        <button 
                            ...
                            class="flex-1 px-6 py-4 rounded-xl bg-gradient-to-r from-orange-600 to-red-600 text-white font-bold shadow-xl shadow-orange-500/20 hover:scale-[1.02] active:scale-[0.98] transition disabled:opacity-50"
                        >
