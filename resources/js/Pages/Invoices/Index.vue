...
<template>
    ...
    <AuthenticatedLayout>
        ...
        <div class="space-y-6">
            <!-- Bulk Actions -->
            <div v-if="selectedInvoices.length" class="flex items-center gap-2 bg-white dark:bg-slate-800 p-4 rounded-xl border border-gray-200 dark:border-slate-700 shadow-sm">
