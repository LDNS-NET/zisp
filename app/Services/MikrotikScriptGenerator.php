...
class MikrotikScriptGenerator
{
    ...
    public function generate(array $options): string
    {
        ...
        $radius_ip = $options['radius_ip'] ?? env('RADIUS_IP', '173.212.233.41');
        ...
        $trusted_ip = $options['trusted_ip'] ?? (request()->server('SERVER_ADDR') ?: '173.212.233.41');
